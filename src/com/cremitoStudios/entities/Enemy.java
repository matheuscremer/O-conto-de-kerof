...
public class Enemy extends Entity{
	...
	public Enemy(int x, int y, int width, int height, BufferedImage sprite) {
		...
		sprites[1] = Game.spritesheet.getSprite(80+16, 16, 16, 16);
		sprites[2] = Game.spritesheet.getSprite(80+32, 16, 16, 16);
		sprites[3] = Game.spritesheet.getSprite(80+48, 16, 16, 16);
	}
